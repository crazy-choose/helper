...
type Position struct {
	...
	OpenVolume         int             `json:"open_volume "gorm:"column:open_volume;comment:开仓量;"`                                        // 开仓量
	CloseVolume        int             `json:"close_volume "gorm:"column:close_volume;comment:平仓量;"`                                      // 平仓量
	OpenAmount         decimal.Decimal `json:"open_amount "gorm:"column:open_amount;comment:开仓金额;"`                                       // 开仓金额
	CloseAmount        decimal.Decimal `json:"close_amount "gorm:"column:close_amount;comment:平仓金额;"`                                     // 平仓金额
	PositionCost       decimal.Decimal `json:"position_cost "gorm:"column:position_cost;comment:持仓成本=上日持仓*昨结算价*合约乘数+SUM(今日持仓*开仓价*合约乘数);"` // 持仓成本=上日持仓 * 昨结算价 * 合约乘数 + SUM（今日持仓 * 开仓价 * 合约乘数）
	CloseProfit        decimal.Decimal `json:"close_profit "gorm:"column:close_profit;comment:平仓盈亏;"`                                     // 平仓盈亏
	PositionProfit     decimal.Decimal `json:"position_profit "gorm:"column:position_profit;comment:持仓盈亏;"`                               // 持仓盈亏
	OpenCost           decimal.Decimal `json:"open_cost "gorm:"column:open_cost;comment:开仓成本;"`                                           // 开仓成本
	LongFrozen         int             `json:"long_frozen "gorm:"column:long_frozen;comment:多头冻结;"`                                       // 多头冻结
	ShortFrozen        int             `json:"short_frozen "gorm:"column:short_frozen;comment:空头冻结;"`                                     // 空头冻结
	LongFrozenAmount   decimal.Decimal `json:"long_frozen_amount "gorm:"column:long_frozen_amount;comment:开仓冻结金额;"`                       // 开仓冻结金额
	ShortFrozenAmount  decimal.Decimal `json:"short_frozen_amount "gorm:"column:short_frozen_amount;comment:开仓冻结金额;"`                     // 开仓冻结金额
	PreMargin          decimal.Decimal `json:"pre_margin "gorm:"column:pre_margin;comment:上次占用的保证金;"`                                     // 上次占用的保证金
	UseMargin          decimal.Decimal `json:"use_margin "gorm:"column:use_margin;comment:占用的保证金;"`                                       // 占用的保证金
	FrozenMargin       decimal.Decimal `json:"frozen_margin "gorm:"column:frozen_margin;comment:冻结的保证金;"`                                 // 冻结的保证金
	FrozenCash         decimal.Decimal `json:"frozen_cash "gorm:"column:frozen_cash;comment:冻结的资金;"`                                      // 冻结的资金
	FrozenCommission   decimal.Decimal `json:"frozen_commission "gorm:"column:frozen_commission;comment:冻结的手续费;"`                         // 冻结的手续费
	CashIn             decimal.Decimal `json:"cash_in "gorm:"column:cash_in;comment:资金差额;"`                                               // 资金差额
	Commission         decimal.Decimal `json:"commission "gorm:"column:commission;comment:手续费;"`                                          // 手续费
	PreSettlementPrice decimal.Decimal `json:"pre_settlement_price "gorm:"column:pre_settlement_price;comment:上次结算价;"`                    // 上次结算价
	SettlementPrice    decimal.Decimal `json:"settlement_price "gorm:"column:settlement_price;comment:本次结算价;"`                            // 本次结算价
	SettlementID       int             `json:"settlement_id "gorm:"column:settlement_id;comment:结算编号;index:idx_settlement_id,type:btree"` //结算编号
	ExchangeMargin     decimal.Decimal `json:"exchange_margin "gorm:"column:exchange_margin;comment:交易所保证金;"`                             // 交易所保证金
	CombPosition       int             `json:"comb_position "gorm:"column:comb_position;comment:组合成交形成的持仓;"`                              // 组合成交形成的持仓
	CombLongFrozen     int             `json:"comb_long_frozen "gorm:"column:comb_long_frozen;comment:组合多头冻结;"`                           // 组合多头冻结
	CombShortFrozen    int             `json:"comb_short_frozen "gorm:"column:comb_short_frozen;comment:组合空头冻结;"`                         // 组合空头冻结
	CloseProfitByDate  decimal.Decimal `json:"close_profit_by_date "gorm:"column:close_profit_by_date;comment:逐日盯市平仓盈亏;"`                 // 逐日盯市平仓盈亏
	CloseProfitByTrade decimal.Decimal `json:"close_profit_by_trade "gorm:"column:close_profit_by_trade;comment:逐笔对冲平仓盈亏;"`               // 逐笔对冲平仓盈亏
	StrikeFrozen       int             `json:"strike_frozen "gorm:"column:strike_frozen;comment:执行冻结;"`                                   // 执行冻结
	StrikeFrozenAmount decimal.Decimal `json:"strike_frozen_amount "gorm:"column:strike_frozen_amount;comment:执行冻结金额;"`                   // 执行冻结金额
	AbandonFrozen      int             `json:"abandon_frozen "gorm:"column:abandon_frozen;comment:放弃执行冻结;"`                               // 放弃执行冻结
	ExchangeID         string          `json:"exchange_id "gorm:"column:exchange_id;comment:交易所代码;"`                                      // 交易所代码
	YdStrikeFrozen     int             `json:"yd_strike_frozen "gorm:"column:yd_strike_frozen;comment:执行冻结的昨仓;"`                          // 执行冻结的昨仓
