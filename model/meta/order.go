...
type OrderInfo struct {
	...
	Direction            string          `json:"direction" gorm:"column:direction;comment:买卖方向;"`                                                // 买卖方向
	...
	ForceCloseReason     string          `json:"force_close_reason" gorm:"column:force_close_reason;comment:强平原因;"`                              // 强平原因
	...
	OrderStatus          string          `json:"order_status" gorm:"column:order_status;comment:报单状态;"`                                          // 报单状态
